...
export const adhkar = {
    ...
    async exec({ body, ctx }) {
        ...
        if (body === '1') {
            ...
            await ctx.reply(adhkar_sbh).catch((error) => {
                Error(error);
                console.log(error);
            });
        }
            ...
            await ctx.reply(adhkar_msa).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_nom).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(listadk).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(ad3yh_nboyh).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_al2dan).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_almsgd).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_alwdo2).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_home).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_al5la).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhkar_food).catch((error) => {
                Error(error);
                console.log(error);
            });
            ...
            await ctx.reply(adhka_5tm).catch((error) => {
                Error(error);
                console.log(error);
            });
