...
module.exports = async function Idris_Abkar(bot, Path_appDate, Markup) {
    ...
    bot.action('Idris_Abkar_001', async (ctx) => {
        ...
        caption += "https://server6.mp3quran.net/abkr/001.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_002', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/002.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_003', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/003.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_004', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/004.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_005', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/005.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_006', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/006.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_007', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/007.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_008', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/008.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_009', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server6.mp3quran.net/abkr/009.mp3"
        ctx.reply(caption)
    ...
    bot.action('Idris_Abkar_010', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/010.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_011', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/011.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_012', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/012.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_013', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/013.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_014', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/014.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_015', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/015.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_016', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/016.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_017', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/017.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_018', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/018.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_019', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/019.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_020', async (ctx) => {
        ...
        let caption = "سورة: طه 📖\nالقارئ: ادريس ابكر 🔊"
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/020.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_021', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/021.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_022', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/022.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_023', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/023.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_024', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/024.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_025', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/025.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_026', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/026.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_027', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/027.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_028', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/028.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_029', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/029.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_030', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/030.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_031', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/031.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_032', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/032.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_033', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/033.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_034', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/034.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_035', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/035.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_036', async (ctx) => {
        ...
        let caption = "سورة: يس 📖\nالقارئ: ادريس ابكر 🔊"
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/036.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_037', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/037.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_038', async (ctx) => {
        ...
        let caption = "سورة: ص 📖\nالقارئ: ادريس ابكر 🔊"
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/038.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_039', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/039.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_040', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/040.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_041', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/041.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_042', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/042.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_043', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/043.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_044', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/044.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_045', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/045.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_046', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/046.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_047', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/047.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_048', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/048.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_049', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/049.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_050', async (ctx) => {
        ...
        let caption = "سورة: ق 📖\nالقارئ: ادريس ابكر 🔊"
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/050.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_051', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/051.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_052', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/052.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_053', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/053.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_054', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/054.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_055', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/055.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_056', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/056.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_057', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/057.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_058', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/058.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_059', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/059.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_060', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/060.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_061', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/061.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_062', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/062.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_063', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/063.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_064', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/064.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_065', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/065.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_066', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/066.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_067', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/067.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_068', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/068.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_069', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/069.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_070', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/070.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_071', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/071.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_072', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/072.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_073', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/073.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_074', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/074.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_075', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/075.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_076', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/076.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_077', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/077.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_078', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/078.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_079', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/079.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_080', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/080.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_081', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/081.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_082', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/082.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_083', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/083.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_084', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/084.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_085', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/085.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_086', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/086.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_087', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/087.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_088', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/088.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_089', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/089.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_090', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/090.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_091', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/091.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_092', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/092.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_093', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/093.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_094', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/094.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_095', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/095.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_096', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/096.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_097', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/097.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_098', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/098.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_099', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/099.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_100', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/100.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_101', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/101.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_102', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/102.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_103', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/103.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_104', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/104.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_105', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/105.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_106', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/106.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_107', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/107.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_108', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/108.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_109', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/109.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_110', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/110.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_111', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/111.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_112', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/112.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_113', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/113.mp3' }, { caption: caption })
    ...
    bot.action('Idris_Abkar_114', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server6.mp3quran.net/abkr/114.mp3' }, { caption: caption })
