...
module.exports = async function Badr_Al_Turki(bot, Path_appDate, Markup) {
    ...
    bot.action('Badr_Al_Turki_001', async (ctx) => {
        ...
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/001.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_002', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/002.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_003', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/003.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_004', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/004.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_005', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/005.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_006', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/006.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_007', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/007.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_008', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/008.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_009', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/009.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_010', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/010.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_011', async (ctx) => {
        ...
        caption += "عذراً لايمكن إرسال الملف كصوت لان الحجم اكبر من 50 ميغابايت\n"
        caption += "https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/011.mp3"
        ctx.reply(caption)
    ...
    bot.action('Badr_Al_Turki_012', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/012.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_013', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/013.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_014', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/014.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_015', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/015.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_016', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/016.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_017', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/017.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_018', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/018.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_019', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/019.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_020', async (ctx) => {
        ...
        let caption = "سورة: طه 📖\nالقارئ: بدر التركي 🔊"
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/020.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_021', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/021.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_022', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/022.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_023', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/023.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_024', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/024.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_025', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/025.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_026', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/026.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_027', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/027.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_028', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/028.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_029', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/029.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_030', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/030.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_031', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/031.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_032', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/032.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_033', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/033.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_034', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/034.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_035', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/035.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_036', async (ctx) => {
        ...
        let caption = "سورة: يس 📖\nالقارئ: بدر التركي 🔊"
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/036.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_037', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/037.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_038', async (ctx) => {
        ...
        let caption = "سورة: ص 📖\nالقارئ: بدر التركي 🔊"
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/038.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_039', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/039.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_040', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/040.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_041', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/041.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_042', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/042.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_043', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/043.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_044', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/044.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_045', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/045.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_046', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/046.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_047', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/047.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_048', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/048.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_049', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/049.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_050', async (ctx) => {
        ...
        let caption = "سورة: ق 📖\nالقارئ: بدر التركي 🔊"
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/050.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_051', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/051.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_052', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/052.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_053', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/053.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_054', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/054.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_055', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/055.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_056', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/056.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_057', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/057.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_058', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/058.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_059', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/059.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_060', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/060.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_061', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/061.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_062', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/062.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_063', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/063.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_064', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/064.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_065', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/065.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_066', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/066.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_067', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/067.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_068', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/068.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_069', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/069.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_070', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/070.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_071', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/071.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_072', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/072.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_073', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/073.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_074', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/074.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_075', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/075.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_076', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/076.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_077', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/077.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_078', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/078.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_079', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/079.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_080', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/080.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_081', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/081.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_082', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/082.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_083', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/083.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_084', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/084.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_085', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/085.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_086', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/086.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_087', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/087.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_088', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/088.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_089', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/089.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_090', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/090.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_091', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/091.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_092', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/092.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_093', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/093.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_094', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/094.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_095', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/095.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_096', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/096.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_097', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/097.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_098', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/098.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_099', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/099.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_100', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/100.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_101', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/101.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_102', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/102.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_103', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/103.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_104', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/104.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_105', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/105.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_106', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/106.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_107', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/107.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_108', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/108.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_109', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/109.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_110', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/110.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_111', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/111.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_112', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/112.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_113', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/113.mp3' }, { caption: caption })
    ...
    bot.action('Badr_Al_Turki_114', async (ctx) => {
        ...
        ctx.replyWithAudio({ url: 'https://server10.mp3quran.net/bader/Rewayat-Hafs-A-n-Assem/114.mp3' }, { caption: caption })
